...
<table class="shop_table cart" cellspacing="0">
	<thead>
		<tr>
			...
			<th class="product-thumbnail"><?php esc_html_e( 'Sản phẩm', 'storex' ); ?></th>
			<th class="product-name"></th>
			<th class="product-avail"><?php esc_html_e( 'Avail', 'storex' ); ?></th>
			<th class="product-price"><?php esc_html_e( 'Giá', 'storex' ); ?></th>
			<th class="product-quantity"><?php esc_html_e( 'Số lượng', 'storex' ); ?></th>
			<th class="product-subtotal"><?php esc_html_e( 'Thành tiền', 'storex' ); ?></th>
